...
export type Mutation = {
  ...
  seedPracticeWithBillingItems?: Maybe<SeedPracticeWithBillingItemsPayload>;
...
export type MutationSeedPracticeWithBillingItemsArgs = {
...
export type SeedPracticeWithBillingItemsInput = {
  /**
...
export type SeedPracticeWithBillingItemsPayload = {
  __typename: 'SeedPracticeWithBillingItemsPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  practice: Practice;
};
